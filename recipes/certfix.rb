...
bash "import_certificate" do
  ...
  cwd "/tmp"
  code <<-EOH
  /usr/lib/jvm/java-1.7.0-openjdk.x86_64/bin/keytool -noprompt -import -alias github.sw.ge.com -file /tmp/#{node['aw-pipeline']['github']['server']}.pem -keystore /usr/lib/jvm/java-1.7.0-openjdk-1.7.0.71.x86_64/jre/lib/security/cacerts -storepass changeit
  EOH
end